...
window.TRENT_DATA = {
  ...
  guides: [
    ...
    { tag: '🆕 NOVEDAD', title: 'Qué es Yepexpress y cómo usarlo', read: '3 min', big: true, body: 'A partir de ahora también encontraréis links de Yepexpress, otra app con productos de marca a precios increíbles, igual que Hacoo.\n\n¿Qué es Yepexpress?\nUna app de compras con ropa, zapatillas y accesorios a precios muy reducidos, con envío directo a España. Incluye marcas como Nike, Adidas, New Balance, Moncler, Stone Island, North Face, Ralph Lauren… y muchas más 🔥\n\n¿Cómo funciona?\n1️⃣ Descarga la app Yepexpress en tu móvil\n2️⃣ Usa mi código TRENT14 para un 14% de descuento en tu primera compra 🎁\n3️⃣ Entra a los links que publico y añade al carrito\n\n¿Es igual que Hacoo?\nMuy similar, misma mecánica y mismos precios bajos. Intentaré subir productos de Yepexpress cada día para que tengáis siempre las mejores opciones 💪\n\nLos productos de Yepexpress se identifican fácilmente porque el mensaje incluye la etiqueta (yepex).' },
  ],

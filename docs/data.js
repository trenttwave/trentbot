...
window.TRENT_DATA = {
  ...
  guides: [
    { tag: '🆕 NOVEDAD', title: 'Qué es Yepexpress y cómo usarlo', read: '3 min', big: true, body: 'Una app de compras con ropa, zapatillas y accesorios a precios muy reducidos, con envío directo a España. Incluye marcas como Nike, Adidas, New Balance, Moncler, Stone Island, North Face, Ralph Lauren… y muchas más 🔥\n\n¿Cómo funciona?\n1️⃣ Descarga la app Yepexpress en tu móvil\n2️⃣ Usa mi código TRENT14 para un 14% de descuento en tu primera compra 🎁\n3️⃣ Entra a los links que publico y añade al carrito\n\nMuy similar a Hacoo, misma mecánica y mismos precios bajos. Los productos de Yepexpress se identifican porque el mensaje incluye la etiqueta (yepex).' },
